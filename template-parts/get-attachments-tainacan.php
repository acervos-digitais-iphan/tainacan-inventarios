...
<?php if (sizeof($media_items_thumbs_image) > 0) { ?>
	<span class="title-section"><?php _e('Imagens', 'tainacan_inventarios') ?></span>
	<div class="images">
		<?php
...
<?php if (sizeof($media_items_thumbs_audio) > 0) { ?>
	<span class="title-section"><?php _e('Audios', 'tainacan_inventarios') ?></span>
...
<?php if (sizeof($media_items_thumbs_video) > 0) { ?>
	<span class="title-section"><?php _e('Vídeos', 'tainacan_inventarios') ?></span>
	<div class="attachments">
		<?php
...
<?php if (sizeof($media_items_thumbs_other) > 0) { ?>
	<span class="title-section"><?php _e('Documentos', 'tainacan_inventarios') ?></span>
	<div class="attachments">
		<?php
