...
<div class="col-md-12 inventario">
    <div class="alinhamento-template-inventarios">
        ...
        <div class="entry-content post-inventario">
            <h1 style="margin-top: 0px;" class="is-style-title-tainacan-inventarios-underscore">
                <?php echo get_the_title(); ?>
            </h1>
            <div class="metadata-mobile">
                <div class="header-collapse">
                    <span><?php _e("informações técnicas", 'tainacan_inventarios') ?></span>
            ...
            <div class="entry-content meta-content">
                <div class="share-button-wrapper">
                    ...
                    <a target="_blank" class="share-button share-twitter" href="https://twitter.com/intent/tweet?url=<?php echo $postUrl; ?>&text=<?php echo the_title(); ?>&via=<?php the_author_meta('twitter'); ?>" title="<?php _e('Twittar', 'tainacan_inventarios'); ?>"><i class="tainacan-icon tainacan-icon-1-25em tainacan-icon-twitter"></i></a>
                    <a target="_blank" class="share-button share-facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $postUrl; ?>" title="<?php _e('Compartilhar no Facebook', 'tainacan_inventarios'); ?>"><i class="tainacan-icon tainacan-icon-1-25em tainacan-icon-facebook"></i></a>
                </div>
            </div>
            <?php
                ...
                do_action('tainacan-inventarios-single-item-after-items-related-to-this');
            ?>  
