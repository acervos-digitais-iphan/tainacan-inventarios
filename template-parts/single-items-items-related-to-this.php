...
<div class="tainacan-single-post">
    <section class="tainacan-content">
        ...
        <?php if ( get_theme_mod('tainacan_single_item_related_items_section_label', __( 'Itens relacionados a este', 'tainacan_inventarios' )) != '') : ?>
            <h2 class="tainacan-single-item-section" id="single-item-related-items-label">
                <?php echo esc_html( get_theme_mod('tainacan_single_item_related_items_section_label', __( 'Itens relacionados a este', 'tainacan_inventarios' )) ); ?>
            </h2>
        <?php endif; ?>
        ...
        <div class="single-item-collection--information">
            <?php 
                tainacan_the_related_items_carousel([
                    ...
                    'carousel_args' => [
                        'max_items_per_screen' => get_theme_mod('tainacan_single_item_related_items_max_items_per_screen', 5)
                    ]
                ]);
            ?>
        <div>
