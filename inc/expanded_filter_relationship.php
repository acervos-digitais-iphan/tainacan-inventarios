<?php
//namespace Tainacan_Inventarios\expanded_filter;

function tainacan_inventarios_expanded_filter_relationship_register_hook() {
...
add_action( 'tainacan-register-admin-hooks', 'tainacan_inventarios_expanded_filter_relationship_register_hook');
...
function tainacan_inventarios_expanded_filter_relationship_remove($metadatum) {
...
function tainacan_inventarios_expanded_filter_relationship_replace_prepare_items_args($args, $request) {
...
add_filter('tainacan-api-prepare-items-args', 'tainacan_inventarios_expanded_filter_relationship_replace_prepare_items_args', 10, 2);