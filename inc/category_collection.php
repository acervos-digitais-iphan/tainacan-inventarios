...
class CategoryCollection {
	...
	public $taxonomy_category = 'tainacan_inventarios_collection_category';
	...
	function form() {
		...
		<div class="tainacan-category-taxonomy-collection"> 
			...
			<div class="field">
				<label class="label"><?php _e('Tipo de Coleção:', 'tainacan-inventarios'); ?></label>
	...
	function get_tainacan_inventarios_control_collections() {
...
CategoryCollection::get_instance();
